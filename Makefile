...
# uwachannel/Makefile.  Generated from Makefile.in by configure.
...
pkgdatadir = $(datadir)/alsa-plugins
pkgincludedir = $(includedir)/alsa-plugins
pkglibdir = $(libdir)/alsa-plugins
pkglibexecdir = $(libexecdir)/alsa-plugins
...
am__installdirs = "$(DESTDIR)$(asound_module_pcm_uwadir)"
LTLIBRARIES = $(asound_module_pcm_uwa_LTLIBRARIES)
libasound_module_pcm_uwa_la_DEPENDENCIES =
am_libasound_module_pcm_uwa_la_OBJECTS = pcm_uwa.lo \
...
DIST_SOURCES = $(libasound_module_pcm_uwa_la_SOURCES)
...
libasound_module_pcm_uwa_la_SOURCES = pcm_uwa.c xuwachannel_accelerator.c \
				      ...
				      xuwachannel_accelerator.h xuwachannel_accelerator_hw.h

libasound_module_pcm_uwa_la_LIBADD = -lasound -lpthread 
all: all-am
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am  $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign uwachannel/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign uwachannel/Makefile
...
install-asound_module_pcm_uwaLTLIBRARIES: $(asound_module_pcm_uwa_LTLIBRARIES)
	@$(NORMAL_INSTALL)
	@list='$(asound_module_pcm_uwa_LTLIBRARIES)'; test -n "$(asound_module_pcm_uwadir)" || list=; \
	...
	test -z "$$list2" || { \
	  echo " $(MKDIR_P) '$(DESTDIR)$(asound_module_pcm_uwadir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(asound_module_pcm_uwadir)" || exit 1; \
	  echo " $(LIBTOOL) $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=install $(INSTALL) $(INSTALL_STRIP_FLAG) $$list2 '$(DESTDIR)$(asound_module_pcm_uwadir)'"; \
	  $(LIBTOOL) $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=install $(INSTALL) $(INSTALL_STRIP_FLAG) $$list2 "$(DESTDIR)$(asound_module_pcm_uwadir)"; \
	}

uninstall-asound_module_pcm_uwaLTLIBRARIES:
	@$(NORMAL_UNINSTALL)
	@list='$(asound_module_pcm_uwa_LTLIBRARIES)'; test -n "$(asound_module_pcm_uwadir)" || list=; \
	for p in $$list; do \
	  $(am__strip_dir) \
	  echo " $(LIBTOOL) $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=uninstall rm -f '$(DESTDIR)$(asound_module_pcm_uwadir)/$$f'"; \
	  $(LIBTOOL) $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=uninstall rm -f "$(DESTDIR)$(asound_module_pcm_uwadir)/$$f"; \
	done

clean-asound_module_pcm_uwaLTLIBRARIES:
	-test -z "$(asound_module_pcm_uwa_LTLIBRARIES)" || rm -f $(asound_module_pcm_uwa_LTLIBRARIES)
	@list='$(asound_module_pcm_uwa_LTLIBRARIES)'; \
...
libasound_module_pcm_uwa.la: $(libasound_module_pcm_uwa_la_OBJECTS) $(libasound_module_pcm_uwa_la_DEPENDENCIES) $(EXTRA_libasound_module_pcm_uwa_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(LINK) -rpath $(asound_module_pcm_uwadir) $(libasound_module_pcm_uwa_la_OBJECTS) $(libasound_module_pcm_uwa_la_LIBADD) $(LIBS)
...
installdirs:
	for dir in "$(DESTDIR)$(asound_module_pcm_uwadir)"; do \
...
clean-am: clean-asound_module_pcm_uwaLTLIBRARIES clean-generic \
...
install-data-am: install-asound_module_pcm_uwaLTLIBRARIES
...
uninstall-am: uninstall-asound_module_pcm_uwaLTLIBRARIES

.MAKE: install-am install-strip

.PHONY: CTAGS GTAGS TAGS all all-am check check-am clean \
	clean-asound_module_pcm_uwaLTLIBRARIES clean-generic \
	clean-libtool cscopelist-am ctags ctags-am distclean \
	distclean-compile distclean-generic distclean-libtool \
	distclean-tags distdir dvi dvi-am html html-am info info-am \
	install install-am install-asound_module_pcm_uwaLTLIBRARIES \
